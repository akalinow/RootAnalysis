...
std::string HTTAnalyzerTT::getSampleNameFromFileName(const EventProxyHTT & myEventProxy){
  ...
  else if(fileName.find("WplusHToTauTau_M125")!=std::string::npos) sampleName = "WplusH125";
  else if(fileName.find("WplusHToTauTau_M130")!=std::string::npos) sampleName = "WplusH130";
  else if(fileName.find("WminusHToTauTau_M120")!=std::string::npos) sampleName = "WminusH120";
  else if(fileName.find("WminusHToTauTau_M125")!=std::string::npos) sampleName = "WminusH125";
  else if(fileName.find("WminusHToTauTau_M130")!=std::string::npos) sampleName = "WminusH130";
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
std::string HTTAnalyzerTT::getMatchingName(const EventProxyHTT & myEventProxy){
