#ifndef RootAnalysis_HTTAnalyzerTT_H
#define RootAnalysis_HTTAnalyzerTT_H
...
class HTTHistogramsTT;

class TH1F;
class TLorentzVector;


class HTTAnalyzerTT: public Analyzer{
 ...
 public:
  ...
  HTTAnalyzerTT(const std::string & aName);

  virtual ~HTTAnalyzerTT();
  ...
  static std::string categoryName(unsigned int iCategory){
    if(iCategory==(int)HTTAnalyzerTT::jet0) return "jet0";
    else if(iCategory==(int)HTTAnalyzerTT::jet1_low) return "jet1_low";
    else if(iCategory==(int)HTTAnalyzerTT::jet1_high) return "jet1_high";
    else if(iCategory==(int)HTTAnalyzerTT::vbf_low) return "vbf_low";
  ...
  bool passCategory(const HTTAnalyzerTT::tauTauCategory & aCategory);
 ...
 private:
  ...
  void setHistos(HTTHistogramsTT *histos) { myHistos_ = histos;};

  ///Histograms storage.
  HTTHistogramsTT *myHistos_;
  ...
  //should this HTTAnalyzerTT be able to filter events
  bool filterEvent_;
  ...
  HTTParticle aTau1, aTau2, aMET;
  HTTParticle aGenTau1, aGenTau2;
