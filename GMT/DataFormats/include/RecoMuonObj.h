#ifndef RecoMuonObj_H
#define RecoMuonObj_H

#include <ostream>
#include "TObject.h"
#include <cmath>
class RecoMuonObj : public TObject {
public:
 RecoMuonObj(Float_t pt=0., Float_t eta=0., Float_t phi=0.,Int_t charge=0, UInt_t nrpchits=0., UInt_t ndthits=0., 
...
public:
  ClassDef(RecoMuonObj,5);
};

std::ostream & operator<< (std::ostream &out, const RecoMuonObj &o);
