...
#define R__DICTIONARY_FILENAME DictCint
...
namespace {
  void TriggerDictionaryInitialization_DictCint_Impl() {
...
#line 1 "DictCint dictionary forward declarations' payload"
...
#line 1 "DictCint dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("DictCint",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_DictCint_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_DictCint_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_DictCint() {
  TriggerDictionaryInitialization_DictCint_Impl();
}
