...
/////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
MuTauSpecifics::MuTauSpecifics(svfitAnalyzer * aAnalyzer) : ChannelSpecifics(aAnalyzer){
...
void MuTauSpecifics::setAnalysisObjects(const EventProxyHTT & myEventProxy) {
        ...
        if(myEventProxy.genLeptons &&
           myEventProxy.genLeptons->size()) {
                ...
                else if(aGenTau.getProperty(PropertyEnum::decayMode)!=HTTAnalysis::tauDecaysElectron) myAnalyzer->genLeg2_ = aGenTau;
